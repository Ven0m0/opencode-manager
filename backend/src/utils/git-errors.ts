...
const ERROR_PATTERNS: ErrorPattern[] = [
  ...
  },
  {
    ...
    statusCode: 404,
    patterns: [/repository not found/i, /fatal: .* does not exist/i, /could not resolve host/i],
  },
  {
    code: "PERMISSION_DENIED",
    summary: "Permission denied. Check your repository access and credentials.",
    statusCode: 403,
    patterns: [/permission denied/i, /access denied/i, /not a readable path/i],
  },
  {
    code: "PUSH_REJECTED",
  ...
  },
  {
    ...
    statusCode: 409,
    patterns: [/CONFLICT \(/, /merge conflict/i, /fix conflicts/i],
  },
  {
    code: "NO_UPSTREAM",
    summary: "No upstream branch configured. Push will set upstream automatically.",
    statusCode: 400,
    patterns: [/no upstream branch/i, /has no upstream branch/i, /no upstream configured/i],
  },
  {
    code: "TIMEOUT",
    summary: "Operation timed out. Check your network connection and try again.",
    statusCode: 504,
    patterns: [/timed out/i, /etimedout/i, /connection timed out/i],
  },
  {
    code: "NOT_A_REPO",
  ...
  },
  {
    ...
    statusCode: 400,
    patterns: [/HEAD detached/i, /detached at/i, /detached HEAD/i],
  },
  {
    code: "BRANCH_EXISTS",
    summary: "A branch with that name already exists.",
    statusCode: 409,
    patterns: [/branch .* already exists/i, /fatal: A branch named .* already exists/i],
  },
  {
