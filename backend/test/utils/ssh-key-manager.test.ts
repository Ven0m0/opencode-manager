...
describe("SSH Host Parsing", () => {
  ...
  it("should parse host:port strings", () => {
    expect(parseHostPort("github.com:2222")).toEqual({
      host: "github.com",
      port: "2222",
    });
    expect(parseHostPort("github.com")).toEqual({
      host: "github.com",
      port: "22",
    });
  });
...
-----END EC PRIVATE KEY-----`;
  ...
  it("should reject empty key", async () => {
    const emptyKey = "";
    await expect(writeTemporarySSHKey(emptyKey, "test-empty")).rejects.toThrow(
