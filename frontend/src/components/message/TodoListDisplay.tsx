...
export function TodoListDisplay({
  ...
  }, [scrollCurrentOnly, filteredTodos.length]);
        ...
        <div
          className={
            isCollapsible && items.length > 3
              ? "max-h-[60px] overflow-hidden relative after:absolute after:bottom-0 after:left-0 after:right-0 after:h-4 after:bg-gradient-to-t after:from-card after:to-transparent"
              : ""
          }
        >
          {items.map((todo) => (
