...
export function STTSettings() {
  ...
  useEffect(() => {
    if (
      isTesting &&
      interimTranscript &&
      interimTranscript !== "Processing..." &&
      interimTranscript !== "Recording..."
    ) {
  ...
  useEffect(() => {
    if (preferences?.stt) {
      const sttPrefs = preferences.stt as typeof preferences.stt & {
        model?: string;
                    ...
                    <FormControl>
                      <Combobox
                        ...
                        options={[
                          ...
                          {
                            value: "external",
                            label: "External API (OpenAI Whisper)",
                          },
                        ]}
                    ...
                    <div className="mt-2 p-2 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs font-medium text-red-700 dark:text-red-300">
                          Test failed - {sttError || "no speech detected"}
                        </span>
                      </div>
                    </div>
                  )}
