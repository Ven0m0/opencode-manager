  ...
  const menuItems = [
    {
      ...
      icon: User,
      label: "Account",
      description: "Profile, passkeys, and sign out",
    },
    {
      id: "general",
      icon: Settings2,
    ...
    },
    {
      ...
      icon: GitBranch,
      label: "Git",
      description: "Git identity and credentials for repositories",
    },
    {
      id: "shortcuts",
      icon: Keyboard,
    ...
    },
    {
      ...
      description: "Manage OpenCode configurations, commands, and agents",
    },
    {
      id: "providers",
      icon: Key,
          ...
          >
            <div className="px-6 pt-6 pb-4 flex-shrink-0">
              <TabsList className="grid w-full grid-cols-8 bg-card p-1">
                <TabsTrigger
                  value="account"
                  className="data-[state=active]:bg-blue-600 data-[state=active]:text-white text-muted-foreground transition-all duration-200"
                >
                  Account
                </TabsTrigger>
                <TabsTrigger
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="px-6 pb-6">
                ...
                <TabsContent key="git" value="git" className="mt-0">
                  <GitSettings />
                </TabsContent>
                <TabsContent key="shortcuts" value="shortcuts" className="mt-0">
                  <KeyboardShortcuts />
                </TabsContent>
                <TabsContent key="opencode" value="opencode" className="mt-0">
                  <OpenCodeConfigManager />
                </TabsContent>
                <TabsContent key="providers" value="providers" className="mt-0">
                  <ProviderSettings />
                </TabsContent>
              </div>
            </div>
          ...
          <div className="flex-shrink-0 bg-gradient-to-b from-background via-background to-transparent border-b border-border backdrop-blur-sm px-4 py-4 flex items-center justify-between">
            <div className="flex items-center gap-2 flex-1">
              ...
              <h2 className="text-xl font-semibold bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent">
                {mobileView === "menu"
                  ? "Settings"
                  : menuItems.find((item) => item.id === mobileView)?.label}
              </h2>
            </div>
            <Button
              variant="ghost"
