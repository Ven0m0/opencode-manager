  ...
  switch (status.status) {
    ...
    case "needs_auth":
      return (
        <Badge
          variant="outline"
          className="text-xs flex items-center gap-1 border-yellow-500 text-yellow-600"
        >
    ...
    case "needs_client_registration":
      return (
        <Badge
          variant="outline"
          className="text-xs flex items-center gap-1 border-orange-500 text-orange-600"
        >
          <AlertCircle className="h-3 w-3" />
...
export function McpServerCard({
  ...
  return (
    <div
      className={`flex items-center justify-between gap-3 p-3 rounded-lg border bg-card ${errorMessage ? "border-red-500/50" : "border-border"}`}
    >
