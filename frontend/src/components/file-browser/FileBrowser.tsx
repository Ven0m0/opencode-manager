import { FolderOpen, RefreshCw, Upload, X } from "lucide-react";
...
export function FileBrowser({
  ...
  const handleUploadItems = useCallback(
    ...
    return (
      ...
      >
        ...
        <div className="flex-1 flex overflow-hidden min-h-0 h-full">
          <div
            className={`${isMobile ? "w-full" : "w-[30%]"} border-r border-border px-1 md:px-4 flex flex-col min-h-0 h-full`}
          >
