...
import { type McpAuthStartResponse, type McpServerConfig, type McpStatus, mcpApi } from "@/api/mcp";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader className="px-4 sm:px-6 pt-4 sm:pt-6 pb-2 sm:pb-3 shrink-0 ">
          ...
          <DialogDescription>Toggle MCP servers for this repository</DialogDescription>
        </DialogHeader>
