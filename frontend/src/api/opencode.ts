...
type CreateSessionRequest = NonNullable<
  paths["/session"]["post"]["requestBody"]
>["content"]["application/json"];
type MessageListResponse =
  paths["/session/{sessionID}/message"]["get"]["responses"]["200"]["content"]["application/json"];
...
type CommandRequest = NonNullable<
  paths["/session/{sessionID}/command"]["post"]["requestBody"]
>["content"]["application/json"];
...
type SendPromptResponse =
  paths["/session/{sessionID}/message"]["post"]["responses"]["200"]["content"]["application/json"];
