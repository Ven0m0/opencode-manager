...
export interface components {
  schemas: {
    ...
    FilePartSource:
      | components["schemas"]["FileSource"]
      | components["schemas"]["SymbolSource"]
      | components["schemas"]["ResourceSource"];
    FilePart: {
      id: string;
      sessionID: string;
      messageID: string;
    ...
    ToolState:
      | components["schemas"]["ToolStatePending"]
      | components["schemas"]["ToolStateRunning"]
      | components["schemas"]["ToolStateCompleted"]
      | components["schemas"]["ToolStateError"];
    ToolPart: {
      id: string;
      sessionID: string;
      messageID: string;
    ...
    Part:
      ...
      | components["schemas"]["ReasoningPart"]
      | components["schemas"]["FilePart"]
      | components["schemas"]["ToolPart"]
      | components["schemas"]["StepStartPart"]
      | components["schemas"]["StepFinishPart"]
      | components["schemas"]["SnapshotPart"]
      | components["schemas"]["PatchPart"]
      | components["schemas"]["AgentPart"]
      | components["schemas"]["RetryPart"]
      | components["schemas"]["CompactionPart"];
    ...
    Event:
      | components["schemas"]["Event.tui.prompt.append"]
      | components["schemas"]["Event.tui.command.execute"]
      | components["schemas"]["Event.tui.toast.show"]
      | components["schemas"]["Event.tui.session.select"]
      | components["schemas"]["Event.installation.updated"]
      | components["schemas"]["Event.installation.update-available"]
      | components["schemas"]["Event.project.updated"]
      | components["schemas"]["Event.server.instance.disposed"]
      | components["schemas"]["Event.file.edited"]
      | components["schemas"]["Event.lsp.client.diagnostics"]
      | components["schemas"]["Event.permission.asked"]
      | components["schemas"]["Event.permission.replied"]
      | components["schemas"]["Event.session.status"]
      | components["schemas"]["Event.session.idle"]
      | components["schemas"]["Event.question.asked"]
      | components["schemas"]["Event.question.replied"]
      | components["schemas"]["Event.question.rejected"]
      | components["schemas"]["Event.todo.updated"]
      | components["schemas"]["Event.pty.created"]
      | components["schemas"]["Event.pty.updated"]
      | components["schemas"]["Event.pty.exited"]
      | components["schemas"]["Event.pty.deleted"]
      | components["schemas"]["Event.mcp.tools.changed"]
      | components["schemas"]["Event.file.watcher.updated"]
      | components["schemas"]["Event.lsp.updated"]
      | components["schemas"]["Event.command.executed"]
      | components["schemas"]["Event.vcs.branch.updated"]
      | components["schemas"]["Event.message.updated"]
      | components["schemas"]["Event.message.removed"]
      | components["schemas"]["Event.message.part.updated"]
      | components["schemas"]["Event.message.part.removed"]
      | components["schemas"]["Event.session.compacted"]
      | components["schemas"]["Event.session.created"]
      | components["schemas"]["Event.session.updated"]
      | components["schemas"]["Event.session.deleted"]
      | components["schemas"]["Event.session.diff"]
      | components["schemas"]["Event.session.error"]
      | components["schemas"]["Event.server.connected"]
      | components["schemas"]["Event.global.disposed"];
    GlobalEvent: {
      directory: string;
    ...
    PermissionRuleConfig:
      ...
      | components["schemas"]["PermissionObjectConfig"];
    PermissionConfig:
      | ({
    ...
    MCPStatus:
      | components["schemas"]["MCPStatusConnected"]
      | components["schemas"]["MCPStatusDisabled"]
      | components["schemas"]["MCPStatusFailed"]
      | components["schemas"]["MCPStatusNeedsAuth"]
    ...
    requestBody?: {
      content: {
        "application/json": {
          ...
          variant?: string;
          parts: (
            | components["schemas"]["TextPartInput"]
            | components["schemas"]["FilePartInput"]
            | components["schemas"]["AgentPartInput"]
            | components["schemas"]["SubtaskPartInput"]
          )[];
        };
      };
    };
