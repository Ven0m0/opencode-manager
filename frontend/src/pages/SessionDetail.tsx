...
export function SessionDetail() {
  ...
  const { data: rawMessages, isLoading: messagesLoading } = useMessages(
    opcodeUrl,
    sessionId,
    repoDirectory,
  );
  ...
  }, [sessionId, model, repoDirectory, setSessionStatus]);
  ...
  const handleChildSessionClick = useCallback(
    ...
    >
      ...
      <div className="flex-1 overflow-hidden flex flex-col relative">
        <div
          ...
          className="flex-1 overflow-y-auto overflow-x-hidden pb-28 overscroll-contain [mask-image:linear-gradient(to_bottom,transparent,black_16px,black)]"
        >
