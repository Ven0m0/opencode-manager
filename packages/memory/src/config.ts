import type { AgentConfig, AgentDefinition, AgentRole } from "./agents";
...
const PLUGIN_COMMANDS: Record<
  string,
  { template: string; description: string; agent: string; subtask: boolean }
> = {
  review: {
